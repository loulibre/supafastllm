...
# ==============================================
# Setup Script for Supabase on macOS with Nginx
# ==============================================

# This script sets up Supabase on macOS using Docker.
# It installs dependencies, sets up the environment, and configures Nginx as a reverse proxy.

# ----------------------------
# Define Default Configuration
# ----------------------------
# These variables define the default values for the setup.
# By default, we use Nginx as the proxy and disable Authelia.
